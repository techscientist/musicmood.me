module.exports = function(grunt) {
        ...
        copy: {
          target: {
            files: [{
                  ...
                  src: ['*.html', 'font/**'], // Actual pattern(s) to match.
    ...
    grunt.registerTask('default', ['jshint', 'clean', 'copy', 'cssmin', 'uglify', 'imagemin', 'notify']);
    grunt.registerTask('build', ['jshint', 'clean', 'copy', 'cssmin', 'uglify', 'imagemin', 'notify']);
    grunt.registerTask('build-no-statics', ['jshint', 'cssmin', 'uglify']);
